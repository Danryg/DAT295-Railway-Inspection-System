...
from turtle_navigator import TurtleBot3Directions, TurtleBot3Navigator
...
def main(args=None):
    ...
    # Set initial pose
    initial_pose = navigator.getPoseStamped([0.0, 0.0], TurtleBot3Directions.NORTH)
    ...
    goal_options = [
        {'name': 'Home',
         'pose': navigator.getPoseStamped([-1.0, 1.0], TurtleBot3Directions.EAST)},

        {'name': 'Position 1',
         'pose': navigator.getPoseStamped([10.0, 6.0], TurtleBot3Directions.EAST)},

        {'name': 'Position 2',
         'pose': navigator.getPoseStamped([-9.0, 9.0], TurtleBot3Directions.NORTH)},

        {'name': 'Position 3',
         'pose': navigator.getPoseStamped([-12.0, 2.0], TurtleBot3Directions.NORTH_WEST)},

        {'name': 'Position 4',
         'pose': navigator.getPoseStamped([3.0, -7.0], TurtleBot3Directions.WEST)},
